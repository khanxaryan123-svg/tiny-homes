    ...
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
      <div className="lg:col-span-3 flex items-center justify-between">
        <div className="text-sm text-gray-500">
          ...
          <span> / </span>
          <span className="text-yellow-600 font-medium">Tradeshow</span>
        </div>
      </div>

      <div className="lg:col-span-3">
        <h1 className="text-3xl font-semibold text-gray-900">Tradeshow</h1>
      </div>
      ...
      <aside className="lg:col-span-1">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4 space-y-4">
          ...
          <div className="pt-2 space-y-3">
            <button type="button" className="w-full py-3 rounded-lg bg-yellow-400 hover:bg-yellow-500 text-white font-medium shadow">Search</button>
            <button type="button" onClick={reset} className="w-full py-3 rounded-lg border border-yellow-400 text-yellow-600 font-medium shadow">Reset</button>
          </div>
        </div>
      </aside>
            ...
            sortedResults.map((item, idx) => (
              <div key={idx} className="rounded-2xl overflow-hidden shadow-sm border border-gray-200 bg-white">
                <div className="relative">
                  ...
                  <span className="absolute top-3 left-3 bg-yellow-300 text-gray-900 text-xs font-semibold px-3 py-1 rounded-md">{item.propertyFor}</span>
             ...
             <div className="col-span-full h-64 flex items-center justify-center text-gray-600 font-semibold">
               No results found.
             </div>
          )}
        </div>
      ...
      <aside className="lg:col-span-1 hidden">{/* spacer to keep layout consistent */}</aside>

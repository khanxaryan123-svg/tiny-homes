  ...
  return (
    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
      ...
      <div className="xl:col-span-3">
        <h1 className="text-4xl font-normal text-[#333333] tracking-tight uppercase">Auctions</h1>
      </div>
            ...
            <Link to={`/property/${item.id}`} key={idx} className="block group">
              <div className="rounded-2xl overflow-hidden shadow-sm border border-gray-200 bg-white hover:shadow-md transition-shadow h-full">
                <div className="relative">
                  ...
                  <span className="absolute top-3 left-3 bg-[#D0021B] text-white text-sm font-medium px-4 py-1.5 rounded-lg shadow-sm">Auction</span>
